...
| **[OPERATIONS.md](Reglas%20de%20Negocio%20y%20Finanzas/OPERATIONS.md)** | Recepción, Registro Seguro EFISCO (incl. score crediticio), Cotizaciones (estimación no vinculante entre Recepción y Bahía), Bahías/Órdenes de Trabajo, Mi Perfil, Sincronización con Google Calendar |
...
| Documento | Contenido |
|:---|:---|
| **[TESTING.md](TESTING.md)** | Suite Jest (124 suites / 591 tests), qué cubre cada una, CI en GitHub Actions |
